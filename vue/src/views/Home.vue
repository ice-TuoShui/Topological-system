  ...
  data () {
    return {
      points: [ // 散点图数据
        ...
        { name: '北京', value: [116.407387, 39.904179], itemStyle: { color: '#00EEFF' } }, // 北京
        { name: '陕西', value: [108.953939, 34.266611], itemStyle: { color: '#00EEFF' } }, // 陕西
        { name: '广东', value: [113.266887, 23.133306], itemStyle: { color: '#00EEFF' } } // 广东
      ],
      linesData: [// 线条数据
        { coords: [[104.076452, 30.651696], [87.628579, 43.793301]] },// 四川->新疆
        { coords: [[104.076452, 30.651696], [116.407387, 39.904179]] },// 四川->北京
        { coords: [[104.076452, 30.651696], [103.826777, 36.060634]] },// 四川->甘肃
        { coords: [[104.076452, 30.651696], [102.709372, 25.046432]] },// 四川->云南
        { coords: [[104.076452, 30.651696], [108.327537, 22.816659]] },// 四川->广西
        { coords: [[104.076452, 30.651696], [112.982951, 28.116007]] },// 四川->湖南
        { coords: [[104.076452, 30.651696], [117.020725, 36.670201]] },// 四川->山东
        { coords: [[104.076452, 30.651696], [113.753094, 34.767052]] },// 四川->河南
        { coords: [[104.076452, 30.651696], [112.578781, 37.813948]] },// 四川->山西
        { coords: [[104.076452, 30.651696], [119.296194, 26.101082]] },// 四川->福建
        { coords: [[104.076452, 30.651696], [120.152575, 30.266619]] },// 四川->浙江
        { coords: [[104.076452, 30.651696], [118.763563, 32.061377]] },// 四川->安徽
        { coords: [[104.076452, 30.651696], [113.266887, 23.133306]] },// 四川->广东
        { coords: [[104.076452, 30.651696], [108.953939, 34.266611]] }// 四川->陕西
      ],
      planePath: // 飞机svg
        ...
        series: [
          ...
          { // 线条系列数据
            ...
            effect: { // 线条特效的配置
              ...
              symbol: "arrow", // 特效图形的标记 可选'circle'等  default = this.planePath
